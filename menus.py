    ...
    def mh_menu(self):
        ...
        while True:
            ...
            response = inquirer.select(
                message=f"{self.limit} will be created, {self.num_configs} configs in que",
                choices=live_menu,
            ).execute()
    ...
    def bbl_menu(self):
        ...
        while True:
            ...
            if response == "Select Bot":
                ...
                start = inquirer.text("Define bBands Length range start: ").execute()
                stop = inquirer.text("Define bBands Length range stop: ").execute()
                step = inquirer.text("Define bBands Length range step: ").execute()
