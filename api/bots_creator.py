...
class BotsCreator:
    ...
    #     selected_configs = inquirer.select(message='Select one or more results', choices=rois,
    ...
    #     if csv:
    #         filename = (
    #             f'{self.bot.priceMarket.primaryCurrency}_{self.bot.priceMarket.secondaryCurrency}_{datetime.date.today().month}_{"-"}_{datetime.date.today().day}_{"_"}_{len(bt_results)}_{".config"}')
