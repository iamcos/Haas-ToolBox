...
class FlashCrashBotManager(Haas):
    def __init__(self):
        Haas.__init__(self)
    ...
    def setup_fcb(self, print_errors=False):
        ...
        priceSpreadType = EnumFlashSpreadOptions(
            self.bot.priceSpreadType).value
        ...
        if self.bot.priceSpreadType <= 1:
            if self.pricespread:
                for p in arange(
                    ...
                    bt_results.append(
                        [bt.roi, bt.totalProfits, len(
                            buy_orders), len(sell_orders), round(p, 2)]
                    )
                    print(
    ...
    def set_price_spread_range(self):
        ...
        self.config_parser.set(
            "FCB_LIMITS", "pricespread_start", self.pricespread[0])
        self.config_parser.set(
            "FCB_LIMITS", "pricespread_end", self.pricespread[1])
        self.config_parser.set(
            "FCB_LIMITS", "pricespread_step", self.pricespread[2])
        self.write_file()

    def set_percentage_range(self):

        start = inquirer.text(
            message="Enter percentage Start range: ").execute(),
        ...
        try:
            ...
            print(e)
        self.config_parser.set(
            "FCB_LIMITS", "percentageboost_start", self.percentageboost[0])
        self.config_parser.set(
            "FCB_LIMITS", "percentageboost_end", self.percentageboost[1])
        self.config_parser.set(
            "FCB_LIMITS", "percentageboost_step", self.percentageboost[2])
        self.write_file()

    def set_multiplier_range(self):

        start = inquirer.text(
            message="Enter multiplyer Start range: ").execute(),
        ...
        try:
            ...
            print(e)
        self.config_parser.set(
            "FCB_LIMITS", "multiplyer_start", self.multiplyer[0])
        self.config_parser.set(
            "FCB_LIMITS", "multiplyer_end", self.multiplyer[1])
        self.config_parser.set(
            "FCB_LIMITS", "multiplyer_step", self.multiplyer[2])
        self.write_file()
    ...
    def set_min_range(self):
        ...
        try:
            ...
            print(e)
        self.config_parser.set(
            "FCB_LIMITS", "multiplyer_min_start", self.multiplyer_min[0])
        self.config_parser.set(
            "FCB_LIMITS", "multiplyer_min_end", self.multiplyer_min[1])
        self.config_parser.set(
            "FCB_LIMITS", "multiplyer_min_step", self.multiplyer_min[2])
        self.write_file()
    ...
    def set_max_range(self):
        ...
        try:
            ...
            print(e)
        self.config_parser.set(
            "FCB_LIMITS", "multiplyer_max_start", self.multiplyer_max[0])
        self.config_parser.set(
            "FCB_LIMITS", "multiplyer_max_end", self.multiplyer_max[1])
        self.config_parser.set(
            "FCB_LIMITS", "multiplyer_max_step", self.multiplyer_max[2])
        self.write_file()
        ...
        while True:
            ...
            if self.bot is None:
                ...
                resp = inquirer.select(
                    message='Menu:', choices=menu_items).execute()
                if resp == 'Select bot':
                ...
                menu_items = ["Select another bot",
                              'Set Buy Amount', 'Set Sell Amount']
                ...
                if resp == "Backtest":
                    print(
                        f'{self.bot.name} bot selected, backtesting procedure initiated')
