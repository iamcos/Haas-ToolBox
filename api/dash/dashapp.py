...
from api.dash import Input, Output
...
from BaseHaas import MarketData
from bot_sellector import BotSellector
import btalib
...
def get_market_data_and_save_to_db( market, primarycoin, secondarycoin, interval, depth):
        ...
        # market_history.to_csv(f'{table_name}.config')
...
def app():
    ...
    #     print(marketobj)
    #     market_data = market_data().get_last_minute_ticker(marketobj)
