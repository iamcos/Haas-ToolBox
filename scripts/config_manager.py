...
class ConfigManager:
	...
	def get_config_data(self) -> ConfigParser:
		config_parser: ConfigParser = ConfigParser()
		# Config Parser Activation
	...
	def check_config(self):
		...
		if not os.path.exists("config/config.ini"):
			...
			print(self.config.__dict__,'cfg')
	...
	def write_file(self):
		self.config.write(open("config/config.ini", "w"))
		self.read_limits()
	...
	def generate_client(self) -> HaasomeClient:
		...
		return HaasomeClient(self.ip, self.secret)